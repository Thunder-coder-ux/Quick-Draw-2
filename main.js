...
ramdom_num = Math.floor((Math.random()*quick_draw_data_set.length)+1);

Element_of_array = quick_draw_data_set[ramdom_num];
document.getElementById("draw_sketch").innerHTML = "Sketch to be drawn : " + Element_of_array;
console.log(ramdom_num);
